...
1.  **Power on your router.** The router should boot in under
    ...
    [why .42]({{< relref "wiki/Default_network_numbering.md" >}})?)
...
3.  **Configure your router's default password.** In your web browser,
    ...
    also [why 81]({{< relref "wiki/FAQ.md" >}})?). (You can ignore the
...
[Setting up SQM]({{< relref "wiki/Setting_up_SQM_for_CeroWrt_310.md" >}}) in the
router.
...
[Bufferbloat]({{< relref "wiki/Wiki.md" >}}) project, and
