...
interactive applications, <link>gaming</link> and [VoIP]({{< relref "wiki/VOIP.md" >}}). It
...
<link>NTP</link>, <link>DHCP</link>, gamers and [VoIP]({{< relref "wiki/VOIP.md" >}}). This
...
-   [Bufferbloat wikipedia](http://en.wikipedia.org/wiki/Bufferbloat)
    ,[Dark Buffers]({{< relref "wiki/Dark_buffers.md" >}})
