...
The [Dogfood Principle]({{< relref "wiki/bloat/Dogfood_Principle.md" >}}) page covers the settings on the
...
[Bloat-videos]({{< relref "wiki/cerowrt/Bloat-videos.md" >}}) page for some details on that.
...
we're running the [Yurtlab]({{< relref "wiki/cerowrt/Yurtlab.md" >}}) instead, (and we are
...
But many can get to 20 or below. See also: [Known Bloated Drivers]({{< relref "wiki/bloat/Bloated_Driver_List.md" >}}) for more information and patches.
...
NOTE: with [codel]({{< relref "wiki/codel/Wiki.md" >}}), this is no longer needed
either.
...
/etc/networks/if-up.d [wlan script]({{< relref "wiki/bloat/Wlan_script.md" >}}) for this is available.
