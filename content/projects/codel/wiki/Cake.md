...
fq\_codel based sqm-scripts [SQM]({{< relref "projects/cerowrt/wiki/SQM.md" >}}) for aqm/fq/qos
...
approach to inbound traffic management, see [Bobbie]({{< relref "projects/codel/wiki/Bobbie.md" >}}).
