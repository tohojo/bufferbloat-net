...
fq\_codel based sqm-scripts [SQM]({{< relref "wiki/cerowrt/SQM.md" >}}) for aqm/fq/qos
...
approach to inbound traffic management, see [Bobbie]({{< relref "wiki/codel/Bobbie.md" >}}).
