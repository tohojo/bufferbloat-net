...
7.  CeroWrt routes rather than bridges between networks. It has an mdns
    ...
    on wireless".
8.  Note that the router is configured with [default network numbering]({{< relref "wiki/cerowrt/Default_network_numbering.md" >}}) to use network 172 addresses to try to stay out of
