...
1.  **Power on your router.** The router should boot in under
    ...
    [why .42]({{< relref "projects/cerowrt/wiki/Default_network_numbering.md" >}})?)
...
3.  **Configure your router's default password.** In your web browser,
    ...
    also [why 81]({{< relref "projects/cerowrt/wiki/FAQ.md" >}})?). (You can ignore the
...
4.  **Secure your wireless interfaces** Go to the *Network-&gt;Wireless*
    ...
    to suit your liking. (See also [FAQ]({{< relref "projects/cerowrt/wiki/FAQ.md" >}})) Enable WPA2
...
-   The wireless interfaces are also configured as **open**
    ...
    web GUI, or see the [Automated Configuration of CeroWrt]({{< relref "projects/cerowrt/wiki/Automated_Configuration_of_CeroWrt.md" >}}) page.
-   If you are configuring an interior router rather than your primary
    router, the directions [Setting up an interior gateway router]({{< relref "projects/cerowrt/wiki/Setting_up_an_interior_gateway_router.md" >}}) will be helpful. CeroWrt comes with mesh networking
...
[Setting up SQM]({{< relref "projects/cerowrt/wiki/Setting_up_SQM_for_CeroWrt_310.md" >}}) in the
router.
...
[Bufferbloat]({{< relref "projects/codel/wiki/Wiki.md" >}}) project, and
...
updating the firmware. The [Automated Configuration of CeroWrt]({{< relref "projects/cerowrt/wiki/Automated_Configuration_of_CeroWrt.md" >}}) page allows you to put your parameters into a file and
...
Find the script on the [Automated Configuration of CeroWrt]({{< relref "projects/cerowrt/wiki/Automated_Configuration_of_CeroWrt.md" >}})
page.
...
addresses or DNS, the [Automated Configuration of CeroWrt]({{< relref "projects/cerowrt/wiki/Automated_Configuration_of_CeroWrt.md" >}})
...
manner. It has been moved to the [Automated Configuration of CeroWrt]({{< relref "projects/cerowrt/wiki/Automated_Configuration_of_CeroWrt.md" >}}) page.
