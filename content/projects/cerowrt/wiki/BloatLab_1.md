...
[yurtlab]({{< relref "wiki/cerowrt/Yurtlab.md" >}}).
...
[What's the naming scheme]({{< relref "wiki/cerowrt/What's_the_naming_scheme.md" >}})? Some more details on the
[testlab machines]({{< relref "wiki/cerowrt/Machines.md" >}})

Note this document becomes inaccurate about 5 minutes after written.

See also [using the testlab]({{< relref "wiki/cerowrt/Using_the_testlab.md" >}})
...
-------
  ...
  [Jupiter]({{< relref "wiki/cerowrt/Jupiter.md" >}})    149.20.63.18   2001:4f8:3:203::2    172.29.0.33   16                                                                     UP       Cerowrt GW, primary DNS server   
