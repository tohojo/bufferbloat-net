...
been obsoleted by events and bugs in its design. See [Wondershaper Must Die]({{< relref "wiki/cerowrt/Wondershaper_Must_Die.md" >}}).
...
[SQM]({{< relref "wiki/cerowrt/SQM.md" >}}) implementation, OpenWrt's qos-scripts, IPFire, the
