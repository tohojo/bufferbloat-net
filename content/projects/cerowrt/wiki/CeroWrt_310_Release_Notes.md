...
-   Incorporates [Best Common Practices     38]({{< relref "wiki/cerowrt/CeroWrt_and_BCP38.md" >}}) (BCP38) to defeat Denial of Service attacks which employ
...
-   See also the [Debugging CeroWrt]({{< relref "wiki/cerowrt/Debugging_CeroWrt.md" >}}) page for information to
...
-   A GUI for setting Smart Queue Management (SQM) parameters for
    slower links. See [Setting     up SQM for CeroWrt 3.10]({{< relref "wiki/cerowrt/Setting_up_SQM_for_CeroWrt_310.md" >}}).
...
-   [Best Common Practices 38]({{< relref "wiki/cerowrt/CeroWrt_and_BCP38.md" >}}) (BCP38) is
