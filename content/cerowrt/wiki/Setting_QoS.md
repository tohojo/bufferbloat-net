...
**Note:** These have been superseded by the [Setting up AQM]({{< relref "cerowrt/wiki/Setting_up_AQM.md" >}})
page.
...
-   Go to the Network-&gt;QOS screen on to see the [CeroWrt router configuration]({{< relref "cerowrt/wiki/Cerowrt_router_configuration.md" >}}) page.
...
-   Use these values to fill in the Download and Upload speed fields in
    the [CeroWrt web GUI.]({{< relref "cerowrt/wiki/Cerowrt_router_configuration.md" >}}) It is
...
Decrease the Upload and Download speeds somewhat [in the web GUI]({{< relref "cerowrt/wiki/Cerowrt_router_configuration.md" >}}) until you can do both. You should
