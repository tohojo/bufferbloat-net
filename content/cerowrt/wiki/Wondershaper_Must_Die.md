...
integrated [Smart Queue Management]({{< relref "cerowrt/wiki/Smart_Queue_Management.md" >}}) systems, incorporating
...
Dozens of more sophisticated [Smart Queue Management]({{< relref "cerowrt/wiki/Smart_Queue_Management.md" >}}) scripts
...
alternate line of work that is in CeroWrt's [SQM]({{< relref "cerowrt/wiki/SQM.md" >}}) system.
...
the [SQM]({{< relref "cerowrt/wiki/SQM.md" >}}) code in cerowrt, or the [traffic shaping example in
