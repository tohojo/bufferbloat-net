...
Current versions of CeroWrt have a [Smart Queue Management]({{< relref "projects/cerowrt/wiki/Smart_Queue_Management.md" >}})
([SQM]({{< relref "projects/cerowrt/wiki/SQM.md" >}})) tab in the Network section that allows you to
...
[enable ECN]({{< relref "projects/cerowrt/wiki/Enable_ECN.md" >}}).
...
then run the [Quick Test for Bufferbloat]({{< relref "projects/cerowrt/wiki/Quick_Test_for_Bufferbloat.md" >}}). If the results are
...
ISP. If you want to experiment, read [Everything you wanted to know about Link Layer Adaptation]({{< relref "projects/cerowrt/wiki/Everything_you_wanted_to_know_about_Link_Layer_Adaptation.md" >}}). And join the [CeroWrt-Devel mailing
