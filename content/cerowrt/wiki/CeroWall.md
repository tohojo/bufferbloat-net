...
free zone to share with guests. Part of it is the [device naming scheme]({{< relref "projects/cerowrt/wiki/Device_naming_scheme.md" >}}), and the other part is the limited pattern matching
...
routes on the outside interface. In [Bloatlab 1]({{< relref "projects/cerowrt/wiki/BloatLab_1.md" >}}), that's not
